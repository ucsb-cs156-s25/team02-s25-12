...
|---------------------------|--------------|-----------|
| UCSBDiningCommonsMenuItem | Jay Joo      | tizerk    |
| UCSBOrganization          | Yuxiang Zhang| yxz29315  |
| RecommendationRequest     | Hung Khuu    | Hungkhuu04|
| MenuItemReview            | Simon Yan    | simony05  |
| HelpRequest               | Michael Wu   | mic-wu    |
| Articles                  | Arthur Wu    | arthurwu17|
